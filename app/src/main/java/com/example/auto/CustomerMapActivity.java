    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRequest.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mRequest.setText("Getting Your Auto...");
...
//        });
        ...
        driverLocationRefListener = driverLocationRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists() && requestBol) {
                    ...
                    if (distance < 100) {
                        mRequest.setText("Auto Arrived");
                    } else {
                        int dis = (int) distance / 1000;
                        mRequest.setText("Auto Found: " + String.valueOf(dis) + " Kms away...");

                    }

                    mDriverMarker = mMap.addMarker(new MarkerOptions().position(driverLatLng).title("Your Auto").icon(BitmapDescriptorFactory.fromResource(R.drawable.auto)));
                }
    ...
    private void getDriversAround() {
        ...
        geoQuery.addGeoQueryEventListener(new GeoQueryEventListener() {
            ...
            public void onKeyEntered(String key, GeoLocation location) {
                ...
                Marker mDriverMarker = mMap.addMarker(new MarkerOptions().position(driverLocation).title(key).icon(BitmapDescriptorFactory.fromResource(R.drawable.auto)));
                assert mDriverMarker != null;
                ...
                new android.app.AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ActivityCompat.requestPermissions(CustomerMapActivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.ACCESS_COARSE_LOCATION}, 1);
    ...
    private void endRide() {
        ...
        mRequest.setText("Request An Auto");
                        ...
                        case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                            try {
                                ...
                                resolvableApiException
                                        .startResolutionForResult(CustomerMapActivity.this, 1);
